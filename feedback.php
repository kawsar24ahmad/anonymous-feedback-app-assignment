...
use App\feedback\FeedbackWriting;

$user_id = isset($_SERVER['QUERY_STRING']) ? (int) $_SERVER['QUERY_STRING'] : 0;

$errors = [];
$feedbackWriting = new FeedbackWriting($user_id, $errors);
$feedbackWriting->writeFeedback();
$feedbackReading = new FeedbackReading($user_id, $errors, "database.json");
$userName = $feedbackReading->getUserName($user_id);
            ...
            <div class="mx-auto max-w-xl">
                <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
                    <div class="mx-auto w-full max-w-xl text-center">
                        ...
                        <h3 class="text-gray-500 my-2">Want to ask something or share a feedback to <strong><?= $userName ?></strong> ?</h3>
                    </div>

                    <div class="mt-10 mx-auto w-full max-w-xl">
                        <form class="space-y-6" action="<?=  $_SERVER["PHP_SELF"].'?'. $user_id; ?>" method="POST">
                            <div>
