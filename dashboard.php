...
$filename = "feedback-store.json";
$feedbackReading = new FeedbackReading($user_id, $errors, $filename);

$single_feedback = $feedbackReading->getFeedback($feedbackReading->readFeedback());
...
<header class="bg-white">
    <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <div class="hidden lg:flex lg:flex-1 lg:justify-end">
            ...
            <a class="ml-4 text-red-500" href="logout.php">Log Out</a>
        </div>
    </nav>
    ...
    <div class="relative flex min-h-screen overflow-hidden bg-gray-50 py-6 sm:py-12">
        ...
        <div class="relative max-w-7xl mx-auto">
            <div class="flex justify-end">
                <span class="block text-gray-600 font-mono border border-gray-400 rounded-xl px-2 py-1">Your feedback form link: <a href="http://localhost:8888/feedback.php?<?= $_SESSION['user_id'] ?>"><strong>http://localhost:8888/feedback.php?<?= $_SESSION['user_id'] ?></strong></a> </span>
            </div>
            <h1 class="text-xl text-indigo-800 text-bold my-10">Received feedback</h1>
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">

            <?php foreach ($single_feedback as $feedback) : ?>
